...
# ============================================================================
# DNS Infrastructure Setup Script for Demo-2026 (ИСПРАВЛЕННЫЙ)
# Версия: 4.3 - Исправлено вычисление обратной зоны
# ============================================================================
...
# ============================================================================
# ВАЖНО: Вычисление обратной зоны ПРАВИЛЬНОЕ
# ============================================================================
# Сначала извлекаем октеты, ПОТОМ формируем обратную зону
